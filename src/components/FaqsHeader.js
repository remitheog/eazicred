            ...
            <div className="hero-faq container-lg">
                <div className="hero-faq__text-box">
                    ...
                    <div className="faq">
                        ...
                        <p>A: Valid Government Issued ID card, BVN, Proof of Residence, 6 months Bank statement for salary account (Consumer loan), 6 months Business bank statement for Business account (SMES), CAC Documentation (SMES), Staff ID card (Consumer loan), Letter of employment and confirmation of employment (Consumer loan)</p>
                    </div>
                    <div className="faq">
                    ...
                    <div className="faq">
                        ...
                        <p>A: No. Everything you need for the loan and repayment process can be done online or over the phone</p>
                    </div>
                    <div className="faq">
                        <h6 className="h-6">Q: How long does it take for loan to be disbursed?</h6>
                        <p>A: 24 hours or less after terms of the loan are agreed Q: Can I preliquidate an existing loan?</p>
                    </div>
                    <div className="faq">
                    ...
                    <div className="faq">
                        ...
                        <p>A: No. A loan cycle has to be completed before starting another one. A new one can be started immediately after the last repayment</p>
                    </div>
                    <div className="faq">
